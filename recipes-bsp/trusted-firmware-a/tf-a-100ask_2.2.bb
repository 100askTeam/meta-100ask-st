require tf-a-100ask-common_${PV}.inc
require tf-a-100ask-common.inc

SUMMARY = "Trusted Firmware-A for STM32MP1"
LICENSE = "BSD-3-Clause"

PROVIDES += "virtual/trusted-firmware-a"
#?PROVIDES += "virtual/tf-a-100ask"
...
# ---------------------------------
#include ${@oe.utils.ifelse(d.getVar('ST_ARCHIVER_ENABLE') == '1', 'tf-a-100ask-archiver.inc','')}
