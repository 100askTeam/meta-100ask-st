...
SRC_URI_append_stm32mpcommon = " file://brcmfmac43360-sdio.txt "
...
do_install_append_stm32mpcommon() {
   ...
   install -m 0644 ${WORKDIR}/brcmfmac43360-sdio.txt ${D}${nonarch_base_libdir}/firmware/brcm/
   install -m 0644 ${WORKDIR}/brcmfmac43360-sdio.txt ${D}${nonarch_base_libdir}/firmware/brcm/brcmfmac43362-sdio.100ask,stm32mp157c-100ask-512d-v1.txt
   install -m 0644 ${WORKDIR}/brcmfmac43430-sdio.txt ${D}${nonarch_base_libdir}/firmware/brcm/
   install -m 0644 ${WORKDIR}/brcmfmac43430-sdio.txt ${D}${nonarch_base_libdir}/firmware/brcm/brcmfmac43430-sdio.st,stm32mp157c-100ask-512d-v1.txt
   install -m 0644 ${WORKDIR}/brcmfmac43362-sdio.txt ${D}${nonarch_base_libdir}/firmware/brcm/
   install -m 0644 ${WORKDIR}/brcmfmac43362-sdio.txt ${D}${nonarch_base_libdir}/firmware/brcm/brcmfmac43362-sdio.st,stm32mp157c-100ask-512d-v1.txt
...
FILES_${PN}-bcm43430_append_stm32mpcommon = " \
  ${nonarch_base_libdir}/firmware/brcm/brcmfmac434360-sdio.txt \
  ${nonarch_base_libdir}/firmware/brcm/brcmfmac434360-sdio.100ask,stm32mp157c-100ask-512d-v1.txt \
  ${nonarch_base_libdir}/firmware/brcm/brcmfmac43430-sdio.txt \
  ${nonarch_base_libdir}/firmware/brcm/brcmfmac43430-sdio.st,stm32mp157c-100ask-512d-v1.txt \
